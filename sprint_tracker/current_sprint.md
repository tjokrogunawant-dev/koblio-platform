...
| P1-T11 | Auth Module — Student Login & RBAC enforcement | Backend | P0 | done | All AC met. Commit `d65044f`. 121 tests passing. Student login (username/pwd), class code + picture pwd login, dual JWT (Auth0 JWKS + local HS256), RBAC role-check endpoints for all 4 roles. |
...
| P1-T12 | User Module — Parent-Child Linking & School Association | Backend | P0 | pending | Depends: P1-T10 (done), P1-T11 (done). Ready to start. |
...
| P1-T11 | Auth Module — Student Login & RBAC enforcement | S03 | `d65044f` |
