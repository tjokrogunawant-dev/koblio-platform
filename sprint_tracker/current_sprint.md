...
| P1-T07 | Next.js 15 app bootstrap — teacher dashboard shell | Frontend | P1 | done | All AC met: Tailwind CSS v4 + PostCSS configured, shadcn/ui Button/Input/Card components, route pages (/, /login, /dashboard), .env.example with env config, TypeScript strict with zero errors, Vitest setup with 20 tests passing, lint clean |
