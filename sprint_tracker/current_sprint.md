...
| P1-T11 | Auth Module — Student Login & RBAC enforcement | Backend | P0 | done | All AC met. Student login, class code resolution, RBAC role-check endpoints for all 4 roles. 121 tests passing. |
