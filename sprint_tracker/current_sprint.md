...
| P1-T11 | Auth Module — Student Login & RBAC enforcement | Backend | P0 | done | All AC met. Student login (username/password), class code resolution, RBAC guards for all 4 roles, 403 on unauthorized. 125 tests passing. |
