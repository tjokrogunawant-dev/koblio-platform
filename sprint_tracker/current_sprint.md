...
| P1-T11 | Auth Module — Student Login & RBAC enforcement | Backend | P0 | done | All AC met. Commit `1644243`. 77 auth tests, 125 total passing. Student login (username/password), class code login (picture password), RBAC guards enforced for all 4 roles. |
...
| P1-T11 | Auth Module — Student Login & RBAC enforcement | S03 | `1644243` |
