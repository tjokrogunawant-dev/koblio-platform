...
| P1-T11 | Auth Module — Student Login & RBAC enforcement | Backend | P0 | done | All AC met. Commit `0df0525`. 127 unit tests passing. Student login (username/password), class code login (K-2 picture password), dual-mode JWT, RBAC guards on all endpoints. |
...
| P1-T11 | Auth Module — Student Login & RBAC enforcement | S03 | `0df0525` |
