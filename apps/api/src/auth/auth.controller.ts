...
import { EmailLoginDto, StudentLoginDto, ClassCodeLookupDto } from './dto/login.dto';
...
export class AuthController {
  ...
  @Public()
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Login as student (username + password, no email — COPPA)' })
  ...
  @Public()
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Resolve a class code to classroom info (for student login flow)' })
